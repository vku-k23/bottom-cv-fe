...
export function ApplicationCard({
  ...
  return (
    <>
      <div
        className="flex cursor-pointer flex-col gap-4 rounded-lg border border-gray-100 bg-white p-4 shadow-sm transition-shadow hover:shadow-md"
